...
$$h_{i; k; t} \equiv \frac{\delta_{i; k; t} + \sum_{j=1}^{26} q_{j, i; k; t}}{W_{i; k; t} },$$ 
3. the "capital productivity" (flow-flow), 
$$\gamma_{i; k; t} \equiv \frac{ W_{i; k; t} + \Pi_{i; k; t} }{\delta_{i; k; t} +  \sum_{j=1}^{26} q_{j, i; k; t} + W_{i; k; t} },$$ and
4. the profit rate (flow-flow), 
$$r_{i; k; t} \equiv \frac{\Pi_{i; k; t}}{ \delta_{i; k; t} + \sum_{j=1}^{26} q_{j,i; k; t} + W_{i; k; t}}.$$
